...
import com.example.quizapp.databinding.ActivityQuizEightBinding

class QuizEight : AppCompatActivity() {
    private lateinit var binding: ActivityQuizEightBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizEightBinding.inflate(layoutInflater)
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            val id = binding.radioGroupEight.checkedRadioButtonId
            ...
            val myIntent = Intent(this, QuizNine::class.java)
            val extras = Bundle()
