...
import com.example.quizapp.databinding.ActivityQuizSevenBinding

class QuizSeven : AppCompatActivity() {
    private lateinit var binding: ActivityQuizSevenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizSevenBinding.inflate(layoutInflater)
        ...
        binding.btnSubmit.setOnClickListener {
            val id = binding.radioGroupSeven.checkedRadioButtonId
            ...
            val myIntent = Intent(this, QuizEight::class.java)
            val extras = Bundle()
