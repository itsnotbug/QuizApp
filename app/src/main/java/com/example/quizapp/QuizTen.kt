...
import com.example.quizapp.databinding.ActivityQuizTenBinding

class QuizTen : AppCompatActivity() {
    private lateinit var binding: ActivityQuizTenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizTenBinding.inflate(layoutInflater)
        ...
        binding.btnSubmit.setOnClickListener {
            val id = binding.radioGroupTen.checkedRadioButtonId
            ...
            val myIntent = Intent(this, Score::class.java)
            val extras = Bundle()
