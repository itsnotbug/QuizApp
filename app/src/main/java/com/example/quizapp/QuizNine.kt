...
import com.example.quizapp.databinding.ActivityQuizNineBinding

class QuizNine : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            val id = binding.radioGroupNine.checkedRadioButtonId
            ...
            val myIntent = Intent(this, QuizTen::class.java)
            val extras = Bundle()
