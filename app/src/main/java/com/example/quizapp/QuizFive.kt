...
import com.example.quizapp.databinding.ActivityQuizFiveBinding

class QuizFive : AppCompatActivity() {
    private lateinit var binding: ActivityQuizFiveBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizFiveBinding.inflate(layoutInflater)
        ...
        binding.btnSubmit.setOnClickListener {
            val id = binding.radioGroupFive.checkedRadioButtonId
            ...
            val myIntent = Intent(this, QuizSix::class.java)
            val extras = Bundle()
