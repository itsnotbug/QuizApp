...
import com.example.quizapp.databinding.ActivityQuizSixBinding

class QuizSix : AppCompatActivity() {
    private lateinit var binding: ActivityQuizSixBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityQuizSixBinding.inflate(layoutInflater)
        ...
        binding.btnSubmit.setOnClickListener {
            val id = binding.radioGroupSix.checkedRadioButtonId
            ...
            val myIntent = Intent(this, QuizSeven::class.java)
            val extras = Bundle()
